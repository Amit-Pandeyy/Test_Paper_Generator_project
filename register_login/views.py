...
from .models import Activation,Teacher,School
...
def sign_up(request):     
        return render(request, '../templates/accounts/sign_up.html')

    
class SignUpTeacherView(GuestOnlyView, FormView):
    template_name = 'accounts/sign_up_teacher.html'
...
class SignUpSchoolView(GuestOnlyView, FormView):
    template_name = 'accounts/sign_up_school.html'
    form_class = SignUpForm
